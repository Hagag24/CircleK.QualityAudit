        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditTemplates_Brands_BrandId",
                        column: x => x.BrandId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditSections_AuditTemplates_TemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WOP = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditItems_AuditSections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CriticalFailedCount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditSessions_AspNetUsers_InspectorId",
                        column: x => x.InspectorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuditSessions_AuditTemplates_TemplateId",
                        column: x => x.TemplateId,
                        principalTable: "AuditTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuditSessions_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditAnswers_AuditItems_ItemId",
                        column: x => x.ItemId,
                        principalTable: "AuditItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuditAnswers_AuditSessions_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditAnswers_ItemId",
                table: "AuditAnswers",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditAnswers_SessionId",
                table: "AuditAnswers",
                column: "SessionId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditItems_SectionId",
                table: "AuditItems",
                column: "SectionId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditSections_TemplateId",
                table: "AuditSections",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditSessions_BranchId",
                table: "AuditSessions",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditSessions_InspectorId",
                table: "AuditSessions",
                column: "InspectorId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditSessions_TemplateId",
                table: "AuditSessions",
                column: "TemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_AuditTemplates_BrandId",
